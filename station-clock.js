...
StationClock.fixedTime = false;
StationClock.fixedHours = 12;
StationClock.fixedMinutes = 0;
...
StationClock.prototype.draw = function() {
    ...
    if (context) {
      ...
      case StationClock.RoundBody:
        ...
        this.strokeCircle(context, "rgb(30,181,237)", 0, 0, 1.1, 0.07);
        context.restore()
        break;
	...
	case StationClock.FlipBody:
      ...
      for (var i = 0; i < 60; i++) {
        ...
        switch (this.dial) {
          ...
          case StationClock.GermanHourStrokeDial:
          	...
          	break;
		case StationClock.FlipBodyDial:
			if ((i % 15) == 0) {
              this.strokeLine(context, 'rgb(30,181,237)', 0.0, -0.98, 0.0, -0.70, 0.05);
          	} else if ((i % 5) == 0) {
			  this.fillCircle(context, 'rgb(30,181,237)', 0.9, 0.0, 0.05, 0.07);
          	}
      ...
      // get current time
        ...
        if(!this.fixedTime){
            ...
            var hours = this.fixedHours;
            var minutes = this.fixedMinutes;
            var seconds = 0;
        }
     ...
     // this.setShadow(context, this.handShadowColor, this.handShadowOffsetX, this.handShadowOffsetY, this.handShadowBlur);
      switch (this.hourHand) {
        ...
        case StationClock.SwissHourHand:
          ...
          break;
		case StationClock.FlipHourHand:
		  this.fillPolygon(context, 'rgb(30,181,237)', -0.05, -0.5, 0.05, -0.5, 0.05, 0.01, -0.05, 0.01);
		  //this.fillRect(context, 'rgb(30,181,237)', 1,1,1,1);
		  break;
      }
      context.restore();
     ...
     // this.setShadow(context, this.handShadowColor, this.handShadowOffsetX, this.handShadowOffsetY, this.handShadowBlur);
      switch (this.minuteHand) {
        ...
        case StationClock.SwissMinuteHand:
        	...
        	break;
		case StationClock.FlipMinuteHand:
		  this.fillPolygon(context, 'rgb(30,181,237)', -0.04, -0.7, 0.04, -0.7, 0.04, 0.01, -0.04, 0.01);
		  //this.fillRect(context, 'rgb(30,181,237)', 1,1,1,1);
		  break;
      }
      context.restore();
     ...
     // this.setShadow(context, this.handShadowColor, this.handShadowOffsetX, this.handShadowOffsetY, this.handShadowBlur);
      switch (this.secondHand) {
        ...
        case StationClock.SwissSecondHand:
          ...
          break;
		case StationClock.FlipSecondHand:
		  this.fillPolygon(context, 'rgb(30,181,237)', -0.03, -0.9, 0.03, -0.9, 0.03, 0.01, -0.03, 0.01);
		  //this.fillRect(context, 'rgb(30,181,237)', 1,1,1,1);
		  break;
       ...
       // this.setShadow(context, this.bossShadowColor, this.bossShadowOffsetX, this.bossShadowOffsetY, this.bossShadowBlur);
        switch (this.boss) {
    		  ...
    		  case StationClock.RedBoss:
    		    ...
    		    break;
			  case StationClock.FlipBoss:
    		    this.fillCircle(context, 'rgb(30,181,237)', 0, 0, 0.1);
    		    break;
        }
        context.restore();
      }
